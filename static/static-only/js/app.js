...
$('#quarters #top-left').fadeTo('fast',0.5);
$('#quarters #top-right').fadeTo('fast',0.5);
$('#quarters #bottom-left').fadeTo('fast',0.5);
$('#quarters #bottom-right').fadeTo('fast',0.5);
$('#quarters h2').hide();


// Top Left
$('#quarters #top-left').mouseenter(function() {
   	$(this).fadeTo('fast',1);
   	$('#top-left-text').fadeTo('fast',1);
});
$('#quarters #top-left').mouseleave(function() {
...
$('#quarters #top-right').mouseenter(function() {
   	$(this).fadeTo('fast',1);
   	$('#top-right-text').fadeTo('slow',1);
});
$('#quarters #top-right').mouseleave(function() {
   $(this).fadeTo('fast',0.5);
   $('#top-right-text').hide();
});

// highlight when hover
$('#quarters #bottom-left ').mouseenter(function() {
   	$(this).fadeTo('fast',1);
   	$('#bottom-left-text').fadeTo('slow',1);
});
$('#quarters #bottom-left').mouseleave(function() {
   $(this).fadeTo('fast',0.5);
   $('#bottom-left-text').hide();
});

// highlight when hover
$('#quarters #bottom-right').mouseenter(function() {
   	$(this).fadeTo('fast',1);
   	$('#bottom-right-text').fadeTo('slow',1);
});
$('#quarters #bottom-right').mouseleave(function() {
   $(this).fadeTo('fast',0.5);
   $('#bottom-right-text').hide();
});
